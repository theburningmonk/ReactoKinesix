...
let info =
  [ "project-name", "ReactoKinesix"
    ...
    "project-summary", "A Rx-based client library for Amazon Kinesis"
    "project-github", "http://github.com/theburningmonk/ReactoKinesix"
    "project-nuget", "http://nuget.com/packages/ReactoKinesix" ]
